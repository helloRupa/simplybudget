    ...
    <div className="bg-slate-800/60 backdrop-blur-sm rounded-2xl border border-slate-600/30 p-6">
      ...
      {showForm && (
        <form
          ...
          noValidate
          className="mb-6 p-4 bg-slate-700/30 rounded-xl border border-slate-600/20 space-y-4"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {!endDate && (
                <p className="text-slate-500 text-xs mt-1">{t("noEndDate")}</p>
              )}
            </div>
          </div>
          ...
          {state.recurringExpenses.map((re) => (
            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-slate-500">{tc(re.category)}</p>
              </div>
