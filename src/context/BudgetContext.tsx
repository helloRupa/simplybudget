  ...
  useEffect(() => {
    ...
    if (loaded.budgetHistory.length === 0) {
      loaded.budgetHistory = [
        { amount: loaded.weeklyBudget, startDate: loaded.firstUseDate },
      ];
