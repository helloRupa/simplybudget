...
import { getDaysInMonth, parseISO, addMonths, addWeeks, startOfMonth } from 'date-fns';
...
function generateWeekly(re: RecurringExpense, today: Date, todayStr: string): { expenses: Expense[]; lastDate: string | null } {
  ...
  // Align cursor to the target day of week
  // Move cursor to the next occurrence of dayOfWeek on or after cursor
